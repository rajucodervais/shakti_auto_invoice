    ...
    for(j=1; j<=count; j++)
    {
      ...
      if(quantity > 0)
      {
        ...
        if(price > 0)
        {
          ...
          console.log(total_cgst);
          console.log(total_sgst);
          console.log(total_igst);
          console.log('hii');
          $('#total_invoice_value').val(total_invoice_value.toFixed(2));
          $('#total_taxable_value').val(total_invoice_value.toFixed(2));
